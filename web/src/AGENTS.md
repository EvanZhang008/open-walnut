...
│   ├── sessions/        # SessionTreePanel, SessionDetailPanel, SessionPanel, SessionExpandedModal, PlanPopup, SessionChatHistory, SessionRow
