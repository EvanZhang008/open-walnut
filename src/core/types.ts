...
export interface ConversationMeta {
  ...
  /** True when this row was rebuilt from an orphaned conversation file (index
   *  self-heal after a sync merge dropped it). Its createdAt is derived from
   *  file content and can predate everything else, so recovered rows are
