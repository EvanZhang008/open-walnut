 ...
 *
 * Walnut's background AI calls (quick-parse, summaries, titles, triage — every
 * `sendMessage` user) talk to Bedrock directly via the SDK
 * (src/model/providers/adapter-bedrock.ts) — they do NOT go through the
