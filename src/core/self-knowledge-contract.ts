...
- \`task_create\` records work only. It does not start work. \`session_start\` starts a session for a task; \`session_send\` messages a live session. Both tell you the outcome by default; pass \`expect_reply: false\` for fire-and-forget.
