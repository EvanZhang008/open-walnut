/**
 * Process registry for background bash sessions.
 * Tracks running and finished processes, manages output buffering.
...
let jobTtlMs = clampTtl(Number.parseInt(process.env.OPEN_WALNUT_BASH_JOB_TTL_MS ?? "", 10));
